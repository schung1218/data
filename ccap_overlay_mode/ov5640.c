		 ...
		 int width, int height, bool nearest)
{
	...
	printk("%s=============>fr %d, width %d height %d\n",__FUNCTION__,fr,width,height);
	return mode;
}
...
static int ov5640_set_mode(struct ov5640_dev *sensor)
{
	...
	printk("%s========xxxxxxxxxxxxxxxxxx======>rate %d\n",__FUNCTION__,rate);
			       ...
			       struct v4l2_mbus_framefmt *format)
{
	...
	case MEDIA_BUS_FMT_UYVY8_2X8:
		...
		printk("%s===========>format->code MEDIA_BUS_FMT_UYVY8_2X8\n",__FUNCTION__);
		break;
	case MEDIA_BUS_FMT_YUYV8_2X8:
		/* YUV422, YUYV */
		fmt = 0x30;
		mux = OV5640_FMT_MUX_YUV422;
		printk("%s===========>format->code MEDIA_BUS_FMT_YUYV8_2X8\n",__FUNCTION__);
		break;
	case MEDIA_BUS_FMT_RGB565_2X8_LE:
		/* RGB565 {g[2:0],b[4:0]},{r[4:0],g[5:3]} */
		fmt = 0x6F;
		mux = OV5640_FMT_MUX_RGB;
		printk("%s===========>format->code MEDIA_BUS_FMT_RGB565_2X8_LE\n",__FUNCTION__);
		break;
	case MEDIA_BUS_FMT_RGB565_2X8_BE:
		/* RGB565 {r[4:0],g[5:3]},{g[2:0],b[4:0]} */
		fmt = 0x61;
		mux = OV5640_FMT_MUX_RGB;
		printk("%s===========>format->code MEDIA_BUS_FMT_RGB565_2X8_BE\n",__FUNCTION__);
		break;
	case MEDIA_BUS_FMT_JPEG_1X8:
		/* YUV422, YUYV */
		fmt = 0x30;
		mux = OV5640_FMT_MUX_YUV422;
		printk("%s===========>format->code MEDIA_BUS_FMT_JPEG_1X8\n",__FUNCTION__);
		is_jpeg = true;
		break;
	case MEDIA_BUS_FMT_SBGGR8_1X8:
		...
		printk("%s===========>format->code MEDIA_BUS_FMT_SBGGR8_1X8\n",__FUNCTION__);
		break;
	case MEDIA_BUS_FMT_SGBRG8_1X8:
		/* Raw bayer, GBGB... / RGRG... */
		fmt = 0x01;
		mux = OV5640_FMT_MUX_RAW_DPC;
		printk("%s===========>format->code MEDIA_BUS_FMT_SGBRG8_1X8\n",__FUNCTION__);
		break;
	case MEDIA_BUS_FMT_SGRBG8_1X8:
		/* Raw bayer, GRGR... / BGBG... */
		fmt = 0x02;
		mux = OV5640_FMT_MUX_RAW_DPC;
		printk("%s===========>format->code MEDIA_BUS_FMT_SGRBG8_1X8\n",__FUNCTION__);
		break;
	case MEDIA_BUS_FMT_SRGGB8_1X8:
		/* Raw bayer, RGRG... / GBGB... */
		fmt = 0x03;
		mux = OV5640_FMT_MUX_RAW_DPC;
		printk("%s===========>format->code MEDIA_BUS_FMT_SRGGB8_1X8\n",__FUNCTION__);
		break;
	default:
		return -EINVAL;
	}
