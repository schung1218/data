...
{0x0004, 0x10},
/* {0x0006, 0x03}, */ //vertical : bit[0]flip, horizontal : bit[1]Mirror
{0x0006, 0x00}, //vertical : flip, horizontal : Normal
{0x0012, 0x0F},
/* {0x0026, 0x77},*/ /*  orig1: 48Mhz orig2:72Mhz */
/* {0x0026, 0x78},*/ /* orig1: 50MHz orig2: */
/* {0x0026, 0x37},*/ /*orig1: 68Mhz orig2: 114Mhz */
{0x0026, 0x57}, /* orig2: 88Mhz */
{0x002A, 0x44},
/* {0x002B, 0x01}, */ /* orig1: system clock / (1/8) */
{0x002B, 0x00}, /* orig2: system clock / (1/4) */
{0x002C, 0x00}, {0x0025, 0x00},
